...
const FORM_NAME = 'ResetPwdForm';

const ResetPwdForm = ({ handleSubmit }) => {
              ...
              <CardContent className={classes.content}>
                ...
                <Grid container spacing={1} justify="center">
                  <p className={classes.infoText}>
                    Please enter your the reset password token & new password.
                    Then, proceed to reset your password.
                  </p>
                </Grid>
...
export default reduxForm({ form: FORM_NAME })(ResetPwdForm);
